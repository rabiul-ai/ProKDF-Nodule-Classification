...
def load_data_and_extract_features(input_images_folder, output_features_folder):
    ...
    for i, filename in enumerate(tqdm(os.listdir(input_images_folder), desc="Processing Images")):
        ...
        if dataset == 'SPIE-AAPM':
            label = 1 if 'c_Y' in filename else 0
            d1_label, d2_label, d3_label = label, label, label
            labels.append([d1_label, d2_label, d3_label])
...
input_images_folder = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p30 SPIE data saving\2D Nodules"
output_features_folder = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p7 extracting textures features 9v\SPIE Dataset Features"
