'''
=============================== ABOUT CODING ==================================
Date: Feb 18, 2025. Copy of p6 ________________________________________
Task: MAJORITY VOTING
    Checking Performance of LBP Images, 9views. ResNet & EfficeintNet
...
code_no = 'p18' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p18 majority voting LBP Res Eff D2'
...
image_folder = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p7 extracting textures features 9v\SPIE Dataset Features\LBP Images"
...
for model_name in model_names:
    ...
    for fold, (train_idx, test_idx) in enumerate(folds):
        ...
        y_pred_prob = best_model.predict(X_test) # shape n_row, 2
