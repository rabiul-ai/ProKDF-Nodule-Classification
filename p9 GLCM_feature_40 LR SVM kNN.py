'''
=============================== ABOUT CODING ==================================
Date: Feb 11, 2024. Copy of p8 ________________________________________
...
code_no = 'p9' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p9 GLCM_feature_40 LR SVM kNN'
...
GLCM_feature_filepath = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p7 extracting textures features 9v\GLCM_features_40.xlsx"
...
def load_selected_HOG_features_and_labels(image_list, HOG_features):
    ...
    X = HOG_features_sampled.iloc[:, 1:-3].values
    y = HOG_features_sampled['d1_label'].values 
...
# for model_name in model_names:
    ...
    for fold, (train_idx, test_idx) in enumerate(folds):
        ...
        X_train, y_train = load_selected_HOG_features_and_labels(train_images, GLCM_features)
        X_test, y_test = load_selected_HOG_features_and_labels(test_images, GLCM_features)
