'''
=============================== ABOUT CODING ==================================
Date: March 6, 2025. Copy of p31 ________________________________________
Task:  MAJORITY VOTING ResNet, EfficientNet
fusion_style = 'majority',

DATASET 2: SPIE-AAPM
MODEL: PRE-TRAINED IN DATASET 1
________________________________________________________

'''

code_no = 'p31' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p33 Pretrained in D1 using for SPIE'
...
# adjusted_probs = adjust_probability_list(diameters, model_probs, kde_benign, kde_malignant, alpha=alpha)
...
# #%%
        ...
        if model_name == 'EfficientNetV2B0':
            pretrained_model = load_model(r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p17 majority voting Res Eff\p17 Model_EfficientNetV2B0_best_model_fold_3.h5")
        
        if model_name == 'ResNet50':
            pretrained_model = load_model(r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p17 majority voting Res Eff\p17 Model_ResNet50_best_model_fold_3.h5")
