...
Task: MAJORITY VOTING
    Checking Performance of HOG Features, 9views. ResNet & EfficeintNet
...
code_no = 'p19' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p19 majority_v HOG_feature LR SVM kNN D2'
...
HOG_feature_filepath = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\p7 extracting textures features 9v\SPIE Dataset Features\HOG_features.xlsx"
