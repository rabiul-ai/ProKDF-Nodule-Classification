'''
=============================== ABOUT CODING ==================================
Date: Feb 22, 2025. Copy of p2 9v searching for best model.py________________________________________
Task: VIEW VARIATION. 3VIEWS
...
code_no = 'p27' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p27 1v Deep Eff saving pickle'
...
"""_____________________ KEEPING FIRST 3 VIEWS ONLY _______________________"""
nodule_to_images_1v = {}
nodule_to_images_3v = {}
nodule_to_images_6v = {}

for key, value in nodule_to_images.items():
    nodule_to_images_1v[key] = value[:1]
    nodule_to_images_3v[key] = value[:3]
    nodule_to_images_6v[key] = value[3:]

if view == '1v':
    nodule_to_images = nodule_to_images_1v
elif view == '3v':
    nodule_to_images = nodule_to_images_3v
elif view == '6v':
    nodule_to_images = nodule_to_images_6v
# Now, I don't need to change the following code.
...
for model_name in model_names:
    ...
    for fold, (train_idx, test_idx) in enumerate(folds):
        ...
        diameters_test_nodules = diameters_test_images[0::n_view] # every nineth element n_view = 3 or 6 or 9
...
# # %%
        ...
        y_test_reshaped = y_test.reshape(-1, n_view) # n_view was = 9
        ...
        if fusion_style == 'average':
            y_pred_prob_reshaped = y_pred_prob.reshape(-1, n_view) # n_view was= 9
            ...
            y_pred_prob_reshaped = y_pred_prob_binary.reshape(-1, n_view)
            y_pred_prob_majority = y_pred_prob_reshaped.sum(axis=1)/n_view  # MAJORITY VOTING here. 
