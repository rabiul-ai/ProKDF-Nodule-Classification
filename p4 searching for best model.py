...
code_no = 'p4' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p4 searching for best model'
...
model_names = ['DenseNet121'] # 'VGG16', 'VGG19' 'ResNet50', 'EfficientNetV2B0', 'InceptionV3', 'MobileNet', 'NASNetMobile', 'DenseNet121', 'ConvNeXtTiny'
n_freeze = 50 
