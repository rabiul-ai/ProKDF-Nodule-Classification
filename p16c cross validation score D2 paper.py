...
output_path = 'Code Outputs/p16c cross validation score D2 paper'
...
filename = "DEEP_Texture_Fused_proba.npy"
...
# among 3 fold first 5 folds elements was 135 and rest 134

def split_list(lst):
    chunk_sizes = [28] * 2 + [27] * 1
    result = []
    index = 0
...
results, scores = get_mean_performance_of_all_folds(performance_metrices, model_name = 'Deep Texture Fused')
save_scores_in_txt_file(output_path, code_no, scores, alpha=0.75, model_name = 'Deep Texture Fused', dia = 'Yes')
