...
Task: Use without dia decision and search for alpha for maximizing f1 score.
'''
...
score_folder = r"C:\Rabiul\1. PhD Research\8. Fall 2024\Lung Project\Coding\5. Coding for Publication\Code Outputs\All Models Pickle Files\Without dia"
...
result = gp_minimize(optimize_weights, search_space_1, n_calls=100, random_state=0)
...
np.save("Texture_Fused_proba.npy", weighted_avg_prob)
np.save("Texture_Fused_y_true.npy", final_prediction)
