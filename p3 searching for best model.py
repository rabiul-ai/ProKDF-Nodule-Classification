...
code_no = 'p3' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p3 searching for best model'
...
model_names = ['InceptionV3', 'MobileNet'] # ,'VGG16', 'VGG19' 'ResNet50', 'EfficientNetV2B0', 'InceptionV3', 'MobileNet', 'NASNetMobile', 'DenseNet121', 'ConvNeXtTiny'
n_freeze = 50 
