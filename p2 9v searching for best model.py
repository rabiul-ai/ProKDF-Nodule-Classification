'''
=============================== ABOUT CODING ==================================
Date: Feb 1, 2024. Copy of p1 ________________________________________
Task: Which pretrained model works better.
Model set VGG16 VGG19 InceptionNet, ResNet, EfficientNet, DenseNet etc
...
output_path = 'Code Outputs/p2 searching for best model'
