'''
=============================== ABOUT CODING ==================================
Date: Feb 18, 2025. Copy of p17 9v searching for best model.py________________________________________
Task:  majority voting on INCEPTION NET, DENSE NET, MOBILE NET
fusion_style = 'majority', 'average'
________________________________________________________

'''

code_no = 'p17b' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p17b majority voting Incep_Dense_Mobile'
...
model_names = ['InceptionV3', 'DenseNet121', 'MobileNet'] # ,'ResNet50', 'VGG16', 'VGG19' 'ResNet50', 'EfficientNetV2B0', 'InceptionV3', 'MobileNet', 'NASNetMobile', 'DenseNet121', 'ConvNeXtTiny'
n_freeze = 50 
