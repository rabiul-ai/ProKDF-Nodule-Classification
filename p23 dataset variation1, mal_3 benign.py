...
code_no = 'p23' # just checking a simple 2D CNN based model accuracy
output_path = 'Code Outputs/p23 dataset variation1, mal_3 benign'
malignancy_3 = 'benign' #'ignored', 'benign', 'malignant'
